...
for  i=1:5:1001#:5:101
    ...
    uInternal[] = uInternal[]
    save(datadir("sims","timeResolution",r,"timeResolution$(i).png"),fig1)


    fig3 = Figure(figure_padding=0,resolution=(1000,1000),fontsize=64)
    ax2 = CairoMakie.Axis(fig3[1,1],aspect=DataAspect())    
    ...
    save(datadir("sims","timeResolution",r,"timeResolutionNeighbours$(i).png"),fig3)
end
